    ...
    private class OnItemClickListener extends RecyclerItemClickListener.SimpleOnItemClickListener {
        ...
        public void onItemClick(View childView, int position) {
            ...
            if (paymentType == Utils.PaymentType.DYNAMIC_PRICING) {
                ...
                client.performDynamicPricing(dynamicPricingRequestType, Const.BILL_URL, new Callback<DynamicPricingResponse>() {
                    @Override
                ...
                try {
                    if (paymentType == Utils.PaymentType.LOAD_MONEY) {
                        paymentType1 = new PaymentType.LoadMoney(amount, Const.RETURN_URL_LOAD_MONEY, netbankingOption);
                        client.loadMoney((PaymentType.LoadMoney) paymentType1, callback);
                    } else if (paymentType == Utils.PaymentType.PG_PAYMENT) {
                        paymentType1 = new PaymentType.PGPayment(amount, Const.BILL_URL, netbankingOption, null);
